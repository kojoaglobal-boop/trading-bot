...
export function runBacktest({ bars, broker, config, mode, portfolio, riskEngine, strategy }) {
  ...
  return {
    ...
    metrics: {
      ...
      winners: tradeAnalytics.summary.winners,
      losers: tradeAnalytics.summary.losers,
      breakEvens: tradeAnalytics.summary.breakEvens,
      winRate: tradeAnalytics.summary.winRate,
      lossRate: tradeAnalytics.summary.lossRate,
      ...
      averageWin: tradeAnalytics.summary.averageWin,
      averageLoss: tradeAnalytics.summary.averageLoss,
      payoffRatio: tradeAnalytics.summary.payoffRatio,
      expectancyPerTrade: tradeAnalytics.summary.expectancyPerTrade,
      expectancyReturnPct: tradeAnalytics.summary.expectancyReturnPct,
      largestWin: tradeAnalytics.summary.largestWin,
      largestLoss: tradeAnalytics.summary.largestLoss,
